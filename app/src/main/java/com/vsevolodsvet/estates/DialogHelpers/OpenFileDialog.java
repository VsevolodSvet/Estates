...
// класс для поиска по файловой системе
public class OpenFileDialog extends AlertDialog.Builder {

    // блок переменных класса
    //region
    // по-умолчанию ищет на SD card
    ...
    // интерфейс для слушателя выбранного файла
    ...
    public OpenFileDialog(Context context) {
        super(context);
        // фильтр для показывания только папок (по умолчанию выключен)
    ...
    // задание фильтра только по папкам
    ...
    // задание иконок для папок и файлов
    //region
    ...
    // метод для перестроения файлов при выборе
